...
Original file is located at
    https://colab.research.google.com/drive/1G1XVoSh7TaTYvmhJZeWQ8cpiSPZXWzKx

# Model that classifies MRI scans to detect Alzheimer’s disease

Our model consists of a ResNet architecture. Nevertheless, in order to fit the model, some transformations need to be done to the initial data.

## Set the environment and dependencies

To use CodeCarbon, first execute the following:
> conda create --name codecarbon

Remember to generate the requirements.txt, in order to install needed dependencies.
"""
...
mlflow.set_tracking_uri("http://localhost:40460") #IP VM i PORT
mlflow.autolog()
...
"""## Define the ResNet architecture and the Residual Block"""
...
"""## Specify the ResNet
Define the model, its hyperparameters, criterion and optimizer.
"""
...
"""This code provides as output the trained model and a csv file containing the CodeCarbon emissions."""